function [eigval, eigvec, eigfun, wn,alphaVec] = KL_analytical(d_KL, l_c, sigma, xnod, img)
...
%% domain data
a = (xnod(end)-xnod(1))/2;
[wn, eigval, eigfun,alphaVec] = analytical_solution(d_KL, a, l_c);
% eigenvectors
...
return;
%%=======================================================================
function [wn,eigval,eigfun,alphaVec] = analytical_solution(M,a,l_c)
c     = 1/l_c;
